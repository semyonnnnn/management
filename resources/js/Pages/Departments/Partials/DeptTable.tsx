        ...
        <div className="bg-white/80 backdrop-blur-sm border border-indigo-200/50">
                  ...
                  // Inside tbody mapping
                    <tbody>
                        {filteredDepartments.map(dept => (
                            ...
                            >
                                <td className="p-3 flex items-center gap-2">{dept.name}</td>
                                <td
                                    className={`p-3 px-2 py-1 text-[9px] font-mono font-bold tracking-wider ${territoryColor[dept.territory]
                                        }`}
                                >
                                ...
                                <td className="p-3">
                                    <div className="w-24 bg-gray-200 h-1 relative">
                                        <div
                                            className={`${levelColor[dept.levelClass]} h-1`}
                                            style={{ width: `${Math.min(dept.levelPercent, 100)}%` }}
                                        />
                                    </div>
            ...
            {selectedDept && (
                <ModalDetails
                    ...
                    levelPercent={selectedDept.levelPercent}   // NEW
                    levelClass={selectedDept.levelClass}       // NEW
