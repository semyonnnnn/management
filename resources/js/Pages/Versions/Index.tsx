...
export default function Index({ versions }: { versions: Version[] }) {
    ...
    const handleApplyVersion = (version: Version) => {
        ...
        router.post(route('versions.delete', { id: version.id }));
    };
                        ...
                        >
                            <div className="p-3 space-y-2">
                                {versions.map((v, idx) => (
                                    <div
                                        key={idx}
                                        className="group border border-indigo-200/50 hover:border-indigo-400 hover:bg-indigo-50/30 transition-all duration-200"
                                        style={{
                                        ...
                                        <div className="p-3 flex justify-between items-center">
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    ...
                                                    className="px-3 py-1.5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white border-0 cursor-pointer text-[10px] font-mono font-bold tracking-wider transition-all duration-200 hover:from-indigo-700 hover:to-purple-700 flex items-center gap-1"
                                                >
